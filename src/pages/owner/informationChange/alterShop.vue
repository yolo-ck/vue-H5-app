      ...
      <div id="personPhoto">
        <div class="people">
          <div class="peoplePhoto" @click="showPickerStyle(3)">
            <img :src="myImage3Src" id="myImage3" alt />
          </div>
          <div class="desc">
        ...
        <div class="papers">
          <div class="papersPhoto" @click="showPickerStyle(4)">
            <img :src="myImage4Src" id="myImage4" alt />
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      stayValidity: {},
      stayValid: undefined,
      myImage3Src: require("../../../img/take_pic.png"),
      myImage4Src: require("../../../img/take_pic.png"),
      shopId: ""
    };
  },
  computed: {
  ...
  beforeRouteEnter(to, from, next) {
    next(vm => {
      if (from.path.indexOf("selectRoom") > -1) {
        vm.$store.commit("SET_KEEP_ALIVE", ["alterShop"]);
      }
    });
  },
  ...
  activated() {
    this.$store.commit("setUserType", "ownerAlterShop");
  },
  mounted() {
    this.$store.commit("setUserType", "ownerAlterShop");
  ...
  methods: {
    ...
    //获取更改前信息
    getBefore() {
      var address = this.$route.params.shopsAddressName.split("-");
      this.$refs.addressComp.addresses = [];
      this.$refs.addressComp.addresses = [
        {
          building: "",
          buildingName: address[0],
          community: "",
          communityName: address[1],
          id: "",
          room: this.$route.params.shopsAddress,
          roomName: address[2]
        }
      ];
      ...
      this.room = this.$route.params.shopsAddress;
      this.stayModel.shopName = this.$route.params.name;
      //照片
      this.stayModel.shopPic = this.$route.params.shopsPic;
      this.myImage3Src = BASE_PATH + this.stayModel.shopPic;
      this.stayModel.shopIcard = this.$route.params.businessLicensePic;
      this.myImage4Src = BASE_PATH + this.stayModel.shopIcard;
    },
    showPickerStyle(tag) {
    ...
    submitHandler() {
      ...
      this.$set(this.shopMessage, "id", this.shopId);
